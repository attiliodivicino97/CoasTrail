...
struct PageViewController: UIViewControllerRepresentable {
    ...
    func makeUIViewController(context: Context) -> UIPageViewController {
        ...
        controllers.forEach({$0.view.backgroundColor = UIColor(Color.champagne) })//colore di sfondo della pagina
        pageViewController.view.backgroundColor = UIColor(Color.green)
